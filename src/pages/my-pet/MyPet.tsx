    ...
    <>
      <div className='header-back'>
        <div className='header-back-title'>
          반려동물이름 
          <img alt='arrow-down-icon' src={arrowDownIcon} onClick={handleMypetSelect}/>
        </div>
      </div>
      <div className='home-container'>
        <Header hiddenLogo hasHeadTab handleTab={ handleMainTab } tabTitles={['케어','병원']}  />
        <h3>마이펫 최근 정보</h3>
          ...
          <h3>총 N건의 케어 내역</h3>
          {
            cares.hospital.map((h:Hospital,index:number)=>(
              <div className='care-box'>
                <div className='title'>
                  {h.name} {h.date}
                  <img alt='arrow-down-icon' src={arrowDownIcon} onClick={()=>handleCareMore(index)}/>
                </div>
                <hr/>
        ...
        <div className='care-container'>
          ...
          <div className='care-box'>
            <div className='title'>
              Dr.KK의 케어 솔루션
              <img alt='arrow-down-icon' src={arrowDownIcon} onClick={()=>handleSolutionMoreOpen()}/>
            </div>
            <hr/>
            <span>____의 케어 히스토리를 분석하여 케어 솔루션을 제공합니다.</span>
            {
              solutionMoreOpen && (
